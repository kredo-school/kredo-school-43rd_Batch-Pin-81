        ...
        <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6">
                          ...
                          <table class="table table-borderless">
                              ...
                              <tr>
                                  <th>Address</th>
                                  <td>{{ $notification->restaurant?->address }}</td>
                              </tr>
                  ...
                  @if($notification->restaurant?->business_license)
                      <a href="{{ asset('storage/' . $notification->restaurant->business_license) }}"
                        target="_blank"
              ...
              <div class="modal-footer">
                ...
                @if($notification->restaurant_status === \App\Models\Restaurant::STATUS_PENDING)
                    ...
                    <form method="POST"
                          action="{{ route('admin.restaurants.reject', $notification->restaurant->id) }}"
                          class="me-3">
                        @csrf
                        @method('PATCH')

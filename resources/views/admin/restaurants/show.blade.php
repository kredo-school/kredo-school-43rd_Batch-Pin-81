...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.restaurants.edit', $restaurant) }}" class="btn btn-dark-blue">
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body">
                    ...
                    <p class="mb-2">
                        ...
                        {{ trim(($restaurant->postal_code ?? '') . ' ' . ($restaurant->prefecture ?? '') . ' ' . ($restaurant->city ?? '') . ' ' . ($restaurant->street_address_building ?? '')) ?: '-' }}
                    </p>

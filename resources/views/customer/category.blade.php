    ...
    <div class="w-100 py-5" style="background-color: #fffefc; min-height: calc(100vh - 70px);">
        <div class="container">
            <div class="d-flex justify-content-between align-items-end mb-4">
                <div>
                    <h3 class="fw-bold m-0 h5" style="color: #0a2540;">Category: {{ $category }}</h3>
                    <p class="text-muted small m-0">Browse our collection of {{ $category }} restaurants</p>
                </div>
                <a href="{{ route('customer.categories.index') }}"
                    class="text-decoration-none small fw-bold text-secondary custom-btn">← Back to Categories</a>
            </div>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-3 g-md-4">
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        <p class="text-muted m-0">No restaurants found in this category.</p>
                    </div>
                @endforelse
            </div>
        </div>

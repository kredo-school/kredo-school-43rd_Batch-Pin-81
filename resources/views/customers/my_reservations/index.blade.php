                ...
                <div class="reservation-card p-3 mb-3 shadow-sm">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-12 col-md-auto text-center">
                            <a href="{{ route('restaurant.show', ['restaurant' => $booking->restaurant_id]) }}">
                                <img src="{{ $booking->restaurant_image ?? 'https://via.placeholder.com/80' }}"
                                    alt="Restaurant image" class="restaurant-img">
                            </a>
                        </div>
                        ...
                        <div class="col mt-0">
                            <div class="reservation-card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center">
                                        <a href="{{ route('restaurant.show', ['restaurant' => $booking->restaurant_id]) }}"
                                            ...
                                            <h3 class="fw-bold mb-0" style="color: #002855">{{ $booking->restaurant_name }}
                                            </h3>
                                        </a>
                                        <div class="meta-code mt-1 mt-md-0 px-2 text-secondary reservation-code">Code:
                                            {{ $booking->reservation_code }}</div>
                                    </div>
                                    <span
                                        class="badge badge-confirmed fw-bold text-white mb-auto">{{ $booking->status }}</span>
                                </div>
                                ...
                                <div
                                    class="reservation-footer d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mt-1">
                                    ...
                                    <div class="reservation-actions d-flex gap-2 flex-wrap">
                                        ...
                                        <button type="button" class="btn btn-danger btn-action-danger"
                    ...
                    <div class="row align-items-center g-3">
                        <div class="col-auto">
                            <div class="bg-secondary rounded text-white d-flex align-items-center justify-content-center"
                                style="width:80px; height:80px;"><i class="bi bi-egg-fried fs-3"></i></div>
                        </div>
                        <div class="col text-muted py-3">
                            No upcoming reservations found.
                            <a href="{{ route('customer.search') }}" class="text-primary text-decoration-none">
                                Book a table now.
                            </a>
                        </div>
                    </div>
            ...
            @forelse($pastReservations ?? [] as $past)
                <div class="reservation-card p-3 mb-3 shadow-sm">
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-12 col-md-auto text-center">
                            <a href="{{ route('restaurant.show', ['restaurant' => $past->restaurant_id]) }}">
                                <img src="{{ $past->restaurant_image ?? 'https://via.placeholder.com/80' }}"
                                    alt="Restaurant image" class="restaurant-img filter-grayscale">
                            </a>
                        </div>
                        ...
                        <div class="col mt-0">
                            <div class="reservation-card-body">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center">
                                        <a href="{{ route('restaurant.show', ['restaurant' => $past->restaurant_id]) }}"
                                            class="text-decoration-none me-3" style="color: #0f2d59;">
                                            <h3 class="fw-bold">{{ $past->restaurant_name }}</h3>
                                        </a>
                                        <div class="meta-code mb-2 px-2 py-0 text-secondary d-inline">Code:
                                            {{ $past->reservation_code }}</div>
                                    </div>
                                </div>
                                ...
                                <div
                                    class="reservation-footer d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mt-3">
                                    <div class="reservation-details d-flex gap-4 gap-md-4">
                                        <div class="detail-text">
                                    ...
                                    <div class="reservation-actions">
                                        <a href="{{ route('booking.create', ['restaurant' => $past->restaurant_id]) }}"
                                            class="btn btn-action-outline">Book Again</a>
                                    </div>
                                </div>
                            </div>
                        </div>

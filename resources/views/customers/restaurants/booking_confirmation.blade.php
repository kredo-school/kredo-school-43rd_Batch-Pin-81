...
@section('content')
    ...
    <div class="container py-5 bg-light" style="font-family: inter">
        <div class="text-center mb-4">
            ...
            <h1 class="fw-bold h2 mb-1" style="color: #0a2540;">Reservation Submitted!</h1>
            <p class="text-muted">
                @if ($reservation->status === 'pending')
                    Your request is pending restaurant approval.
                @else
        ...
        <div class="card-custom shadow-sm bg-white">
            <div class="card-custom-header" style="color: #fff;">
                ...
                <div class="confirmation-label">
                    Reservation Code: <span class="confirmation-code"
                        style="color: #fff;">{{ $reservation->reservation_code }}</span>
                </div>
            </div>
            ...
            <div class="p-4 p-md-5">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <a href="{{ route('my_reservations') }}" class="btn custom-btn-a w-100 fw-semibold"
                            style="color: #0a2540;">My Reservations</a>
                    </div>
                </div>

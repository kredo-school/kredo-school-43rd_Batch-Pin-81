...
<head>
    ...
    <style>
        ...
        :root {
            --brand-dark-blue: #0A2540; /* Figmaの紺色 */
        }
        ...
        .list-group-item-action:hover, .settings-trigger:hover {
        ...
        .settings-trigger.collapsed + .custom-menu-wrap {
            max-height: 0px;
            opacity: 0;
            pointer-events: none; /* 閉じている時はクリックできないようにする */
        }
    </style>
</head>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-brand-navbar px-4 py-3">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('restaurant.dashboard') }}">
                <span class="fw-bold ms-2">Pin+81 <span class="fs-6 fw-normal text-white-50">Restaurant Portal</span></span>
            </a>
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel" style="background-color: #0A2540 !important; width: 300px;">
        ...
        <div class="offcanvas-body p-3">
            ...
            <div class="mt-1">
                ...
                <div id="settingsSubMenu" class="custom-menu-wrap ps-4 pb-2 d-flex flex-column gap-1">
                    <a href="#" class="text-white-50 text-decoration-none py-2 px-3 small rounded-3 d-flex align-items-center list-group-item-action">
                    ...
                    <a href="#" class="text-danger text-decoration-none py-2 px-3 small rounded-3 d-flex align-items-center list-group-item-action">

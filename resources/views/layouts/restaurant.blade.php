        ...
        <div class="offcanvas-body p-3">
            <div class="list-group list-group-flush gap-1">
                ...
                <a href="{{ route('restaurant.profile.edit') }}"
                    class="list-group-item list-group-item-action border-0 rounded-3 py-2 px-3 {{ request()->routeIs('restaurant.profile.*') ? '' : 'bg-transparent text-white-50' }}"
                    style="{{ request()->routeIs('restaurant.profile.*') ? 'background-color: rgba(255, 255, 255, 0.15); color: #fff;' : '' }}">

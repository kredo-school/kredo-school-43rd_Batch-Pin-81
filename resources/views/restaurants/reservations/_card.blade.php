    ...
    <div class="row align-items-md-center text-secondary small gy-2 gy-md-0">
        ...
        <div class="col-12 col-md-3 d-flex justify-content-between align-items-center d-md-block">
            <div>
                ...
                <span class="ms-1 text-muted d-none d-md-inline">#RM{{ str_pad($reservation->id, 3, '0', STR_PAD_LEFT) }}</span>
            </div>

            <div class="d-block d-md-none">
                @if ($reservation->status === 'confirmed')
                    <div class="d-flex gap-2">
                        <form id="mb-completeForm-{{ $reservation->id }}" action="{{ route('restaurant.reservations.update_status', $reservation->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="status" value="completed">
                            <button type="button" class="btn btn-sm text-white fw-bold d-flex align-items-center justify-content-center"
                        ...
                        <form id="mb-cancelForm-{{ $reservation->id }}" action="{{ route('restaurant.reservations.update_status', $reservation->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="status" value="cancelled">
                            <button type="button" class="btn btn-sm btn-list-decline fw-bold d-flex align-items-center justify-content-center"
                ...
                @elseif($reservation->status === 'pending')
                    <div class="d-flex gap-2">
                        <form id="mb-confirmForm-{{ $reservation->id }}" action="{{ route('restaurant.reservations.update_status', $reservation->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="status" value="confirmed">
                            <button type="button" class="btn btn-sm btn-list-confirm fw-bold d-flex align-items-center justify-content-center"
                                style="width: 90px; height: 32px; padding: 0;"
                        ...
                        <form id="mb-declineForm-{{ $reservation->id }}" action="{{ route('restaurant.reservations.update_status', $reservation->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="status" value="cancelled">
                            <button type="button" class="btn btn-sm btn-list-decline fw-bold d-flex align-items-center justify-content-center"
        ...
        <div class="col-12 col-md-2 text-md-center">
            <span class="text-muted d-inline d-md-none me-2">#RM{{ str_pad($reservation->id, 3, '0', STR_PAD_LEFT) }}</span>
        ...
        <div class="col-12 col-md-3 text-md-center">
            ...
            <span class="ms-2"><i class="fa-regular fa-clock me-1"></i> {{ date('H:i', strtotime($reservation->reservation_time)) }}</span>
        </div>
        ...
        <div class="col-md-2 text-end d-none d-md-block">
            @if ($reservation->status === 'confirmed')
                <div class="d-md-flex gap-2 justify-content-md-end">
                    <form id="pc-completeForm-{{ $reservation->id }}" action="{{ route('restaurant.reservations.update_status', $reservation->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('PATCH')
                        <input type="hidden" name="status" value="completed">
                        <button type="button" class="btn btn-sm text-white fw-bold d-flex align-items-center justify-content-center" 
                    ...
                    <form id="pc-cancelForm-{{ $reservation->id }}" action="{{ route('restaurant.reservations.update_status', $reservation->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('PATCH')
                        <input type="hidden" name="status" value="cancelled">
                        <button type="button" class="btn btn-sm btn-list-decline fw-bold d-flex align-items-center justify-content-center" 
            ...
            @elseif($reservation->status === 'pending')
                <div class="d-md-flex gap-2 justify-content-md-end">
                    <form id="pc-confirmForm-{{ $reservation->id }}" action="{{ route('restaurant.reservations.update_status', $reservation->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('PATCH')
                        <input type="hidden" name="status" value="confirmed">
                        <button type="button" class="btn btn-sm btn-list-confirm fw-bold d-flex align-items-center justify-content-center" 
                    ...
                    <form id="pc-declineForm-{{ $reservation->id }}" action="{{ route('restaurant.reservations.update_status', $reservation->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('PATCH')
                        <input type="hidden" name="status" value="cancelled">
                        <button type="button" class="btn btn-sm btn-list-decline fw-bold d-flex align-items-center justify-content-center" 

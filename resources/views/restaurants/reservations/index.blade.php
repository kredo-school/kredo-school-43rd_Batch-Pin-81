...
@section('content')
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    <form action="{{ route('restaurant.reservations') }}" method="GET"
                        class="d-flex align-items-center bg-white px-2 py-1 border border-light shadow-sm"
                        style="border-radius: 8px; height: 38px; width: 180px; margin: 0;">
                        <i class="fa-solid fa-magnifying-glass text-secondary me-2 small"></i>
                        <input type="text" name="search_id" class="datepicker-input" style="width: 130px; cursor: text;"
                            placeholder="Search ID" value="{{ request('search_id') }}">
                        @if (request('date'))
                    ...
                    @if (request('date') || request('search_id'))
                        <a href="{{ route('restaurant.reservations') }}"
                            class="btn btn-sm text-white border-0 d-flex align-items-center justify-content-center"
                ...
                <div class="nav gap-2 scrollable-buttons" id="statusFilterTab" role="tablist">
                    <button class="btn btn-status-filter active" id="tab-all" data-bs-toggle="tab"
                        data-bs-target="#panel-all" type="button" role="tab">All</button>

                    <button class="btn btn-status-filter" id="tab-pending" data-bs-toggle="tab"
                        data-bs-target="#panel-pending" type="button" role="tab">Pending</button>

                    <button class="btn btn-status-filter" id="tab-confirmed" data-bs-toggle="tab"
                        data-bs-target="#panel-confirmed" type="button" role="tab">Confirmed</button>

                    <button class="btn btn-status-filter" id="tab-completed" data-bs-toggle="tab"
                        data-bs-target="#panel-completed" type="button" role="tab">Completed</button>

                    <button class="btn btn-status-filter" id="tab-cancelled" data-bs-toggle="tab"
                        data-bs-target="#panel-cancelled" type="button" role="tab">Cancelled</button>
                </div>
    ...
    {{-- <script src="cdn.jsdelivr.net/npm/bootstrap@5.3.0/…/bootstrap.bundle.min.js"></script> --}}
